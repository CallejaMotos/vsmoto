...
class ThemeFarmer_Field_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script('themefarmer-field-repeater', THEMEFARMER_FIELDS_URI . 'repeater/js/themefarmer-field-repeater.js', array('jquery', 'jquery-ui-sortable', 'jquery-ui-draggable', 'wp-color-picker'), '1.2.1', true);
	}
